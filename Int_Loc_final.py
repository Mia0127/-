...
#dfb1 = dfb1.rename({'B1F_AP01': 'AP01', 'B1F_AP03': 'AP03','B1F_AP05':'AP05'}, axis=1)
df1 = df1.rename({'1F_AP01': 'AP01', '1F_AP03': 'AP03','1F_AP05':'AP05','1F_AP07':'AP07'}, axis=1)
df2 = df2.rename({'2F_AP01': 'AP01', '2F_AP03': 'AP03','2F_AP05':'AP05'}, axis=1)
df3 = df3.rename({'3F_AP01': 'AP01', '3F_AP03': 'AP03','3F_AP05':'AP05','3F_AP07':'AP07','3F_AP09':'AP09'}, axis=1)
df4 = df4.rename({'4F_AP01': 'AP01', '4F_AP03': 'AP03','4F_AP05':'AP05','4F_AP07':'AP07'}, axis=1)
df5 = df5.rename({'5F_AP01': 'AP01', '5F_AP03': 'AP03','5F_AP05':'AP05','5F_AP07':'AP07','5F_AP09':'AP09'}, axis=1)
df6 = df6.rename({'6F_AP01': 'AP01', '6F_AP03': 'AP03','6F_AP05':'AP05','6F_AP07':'AP07','6F_AP09':'AP09'}, axis=1)
df7 = df7.rename({'7F_AP01': 'AP01', '7F_AP03': 'AP03','7F_AP05':'AP05','7F_AP07':'AP07','7F_AP09':'AP09'}, axis=1)
df8 = df8.rename({'8F_AP01': 'AP01', '8F_AP03': 'AP03','8F_AP05':'AP05','8F_AP07':'AP07','8F_AP09':'AP09'}, axis=1)
df9 = df9.rename({'9F_AP01': 'AP01', '9F_AP03': 'AP03','9F_AP05':'AP05','9F_AP07':'AP07'}, axis=1)
df10 = df10.rename({'10F_AP01': 'AP01', '10F_AP03': 'AP03','10F_AP05':'AP05','10F_AP07':'AP07'}, axis=1)
df11 = df11.rename({'11F_AP01': 'AP01'}, axis=1)

df = df1.append(df2, ignore_index=True).append(df3, ignore_index=True).append(df4, ignore_index=True).append(df5, ignore_index=True).append(df6, ignore_index=True).append(df7, ignore_index=True).append(df8, ignore_index=True).append(df9, ignore_index=True).append(df10, ignore_index=True).append(df11, ignore_index=True)
# =============================================================================
